...
bot.on('text', async (ctx) => {
  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      max_tokens: 1000,
      system: "Sen Evolution Logistics kompaniyasining aqlli AI yordamchisisan. Foydalanuvchilarga yuk tashish, tariflar va logistika bo'yicha professional, do'stona va aniq javob ber. Faqat o'zbek, rus va ingliz tillarida javob qaytar.",
